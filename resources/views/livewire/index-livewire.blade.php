                ...
                <div class="rounded-lg bg-white p-4 shadow">
                  ...
                  <div class="mt-4">
                    ...
                    <div class="max-w-xs overflow-hidden">
                        <p class="text-primary mt-2 inline-block whitespace-nowrap rounded-xl font-semibold leading-tight overflow-hidden">
                            <span class="text-sm uppercase">{{ $inmueble->direccion }}</span>
                        </p>
                    </div>
