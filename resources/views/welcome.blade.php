    ...
    <div class="max-w-screen-xl px-4 py-3 mx-auto">
        <div class="flex items-center">
            ...
            <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                ...
                <li>
                    <a href="inmuibles" class="text-gray-900 dark:text-white hover:underline">Company</a>
                </li>
                <li>
                    <a href="proyecto" class="text-gray-900 dark:text-white hover:underline">proyectos</a>
                </li>
                <li>
...
<div class="bg-gray-300 p-2 md:p-4 mx-auto w-full md:w-1/2 mt-4">
    <h3 class="font-bold text-center mt-0">La Inmobiliaria es un Portal Inmobiliario de Venta o Alquiler de Inmuebles en Lima y todo el Perú.</h3>
</div>
...
{{-- termina codigo index home --}}

{{-- <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="rounded-t-lg" src="Image/logoempresa.jpg" alt="" width="100" height="100" />
    </a>
    <div class="p-5">
        <a href="#">
...
<footer class="py-16 text-center text-sm text-black dark:text-blue/70">
